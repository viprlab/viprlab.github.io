...
<object style="display:inline" height="50" data="https://api.elsevier.com/content/abstract/citation-count?doi={{entry.doi}}&apiKey=ad2ec8846dc7f8baaabe4d1b1e607f43&httpAccept=text%2Fhtml"></object>
{% endfor %}
{% endfor %}
